...
/// <summary>
/// Based on https://stackoverflow.com/questions/452902/how-to-read-a-text-file-reversely-with-iterator-in-c-sharp
/// </summary>
...
namespace MiscUtil.IO
{
    ...
    public sealed class ReverseLineReader : IEnumerable<string>
    {
        ...
        public ReverseLineReader(FileStream streamSource)
        ...
        public ReverseLineReader(string filename, Encoding encoding)
            : this(File.Open(filename, FileMode.Open, FileAccess.Read), encoding)
        {
        }
        ...
        public ReverseLineReader(FileStream streamSource, Encoding encoding)
